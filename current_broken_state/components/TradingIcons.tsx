...
export const ChartIconSolid: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor" >
      <path d="M3 3v18h18" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
      <path d="m18 9-5 5-4-4-3 3" stroke="var(--color-primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    </svg>
  );

export const TradeIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const SignalIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const BrainCircuitIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2a4.5 4.5 0 0 0-4.5 4.5v.5a4.5 4.5 0 0 0-4.5 4.5v2a4.5 4.5 0 0 0 4.5 4.5h.5a4.5 4.5 0 0 0 4.5 4.5 4.5 4.5 0 0 0 4.5-4.5h.5a4.5 4.5 0 0 0 4.5-4.5v-2a4.5 4.5 0 0 0-4.5-4.5v-.5A4.5 4.5 0 0 0 12 2Z" />
        <path d="M12 11.5v-1a2 2 0 0 1 2-2" />
        <path d="M12 12.5v1a2 2 0 0 0 2 2" />
        <path d="M14 10.5h1a2 2 0 0 1 2 2" />
        <path d="M14 13.5h1a2 2 0 0 0 2-2" />
        <path d="M12 11.5v-1a2 2 0 0 0-2-2" />
        <path d="M12 12.5v1a2 2 0 0 1-2 2" />
        <path d="M10 10.5h-1a2 2 0 0 0-2 2" />
        <path d="M10 13.5h-1a2 2 0 0 1-2-2" />
        <path d="M12 20.5v-2" />
        <path d="M12 3.5v2" />
        <path d="M16.5 17.5v-1" />
        <path d="M7.5 7.5v1" />
        <path d="M16.5 6.5v1" />
        <path d="M7.5 16.5v-1" />
    </svg>
